...
Relational Databases are where data itself are stored and SQL is a language used to query these databases.

- [ ] Why do tables need a `primary key`?
So that each entry can be uniquely indentified.
